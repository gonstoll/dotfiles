...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>hh', function() harpoon.ui:toggle_quick_menu(harpoon:list(), menu_opts) end, {desc = desc('Open menu')})
    vim.keymap.set('n', '<leader>ha', function() harpoon:list():add() end, {desc = desc('Add to list')})
    vim.keymap.set('n', '<leader>h1', function() harpoon:list():select(1) end, {desc = desc('Select file 1')})
    vim.keymap.set('n', '<leader>h2', function() harpoon:list():select(2) end, {desc = desc('Select file 2')})
    vim.keymap.set('n', '<leader>h3', function() harpoon:list():select(3) end, {desc = desc('Select file 3')})
    vim.keymap.set('n', '<leader>h4', function() harpoon:list():select(4) end, {desc = desc('Select file 4')})
    vim.keymap.set('n', '<leader>h5', function() harpoon:list():select(5) end, {desc = desc('Select file 5')})
    vim.keymap.set('n', '<leader>h6', function() harpoon:list():select(6) end, {desc = desc('Select file 6')})
    vim.keymap.set('n', '<leader>h7', function() harpoon:list():select(7) end, {desc = desc('Select file 7')})
    vim.keymap.set('n', '<leader>h8', function() harpoon:list():select(8) end, {desc = desc('Select file 8')})
    vim.keymap.set('n', '<leader>h9', function() harpoon:list():select(9) end, {desc = desc('Select file 9')}) -- If I ever have more than 9 tabs open, time to rethink my life choices

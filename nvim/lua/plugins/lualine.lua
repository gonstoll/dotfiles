    ...
    if isRosePineTheme then
      ...
      lualineTheme = {
        ...
        inactive = {
          ...
          b = {bg = gruvboxPalette.bg_statusline3[1], fg = gruvboxPalette.grey2[1]},
          c = {bg = gruvboxPalette.bg_statusline3[1], fg = gruvboxPalette.grey2[1]},
          z = {bg = gruvboxPalette.bg_statusline3[1], fg = gruvboxPalette.grey2[1]},
        }
      }
    end
